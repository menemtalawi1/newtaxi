      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <?php echo Form::open(['url' => LOGIN_USER_TYPE.'/send_message', 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label radio_label">User Type<em class="text-danger">*</em></label>
                   <div class="col-md-7 col-sm-offset-1">
                    ...
                    <label class="user_label" id="user_label_type" for="all_type">Rider & Driver & Company</label>
                    </div>
                    <div class="col-sm-6" style="display: flex; margin-bottom: 8px;">
                  ...
                  <div class="col-sm-6" style="display: flex;">
                    <input type="radio" id="all_driver"  name="user_type" value="Driver" class="get_user_class get_user_type" <?php echo e(LOGIN_USER_TYPE=='company'?'checked':''); ?>>
                ...
                <div class="form-group" id="email_textbox" style="display:none">
                  <label for="input_email" class="col-sm-3 control-label">
                    <?php echo e((LOGIN_USER_TYPE == 'company') ? 'Drivers': 'Users'); ?> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    ...
                    <span class="text-danger"><?php echo e($errors->first('txtEditor')); ?></span><br>
                    <span class="text-danger"><?php echo e($errors->first('users')); ?></span><br>
              ...
              <div class="box-footer text-center">
                ...
                <a href="<?php echo e(url(LOGIN_USER_TYPE.'/send_message')); ?>" class="btn btn-default">Cancel</a>
              </div>
              <!-- /.box-footer -->
            <?php echo Form::close(); ?>
...
var err_user="<?php echo e($errors->first('users')); ?>";
...
function init_user()
{
  ...
  if(toval!="to_all")
  {
    ...
    $.ajax({
      type: 'POST',
      url: APP_URL+'/<?php echo e(LOGIN_USER_TYPE); ?>/get_send_users',
      data: "type="+usertype,
      dataType: "json",
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cloneapp/public_html/cabme.cloneappsolutions.com/resources/views/admin/send_message.blade.php ENDPATH**/ ?>