		...
		<div class="height--full separated--sides pull-left full-width">
			<div style="padding:0px;" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 flexbox__item one-fifth page-sidebar hidden--portable hide-sm-760">
				<ul class="site-nav">
					...
					<li class="logout"><a href="<?php echo e(url('deleteacc')); ?>"><?php echo e(trans('messages.header.delete')); ?></a></li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampps\htdocs\new\resources\views/common/dashboard_side_menu.blade.php ENDPATH**/ ?>