...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(url('admin/manage_fare')); ?>">Peak Based Fare</a></li>
    ...
    <div class="row" ng-cloak>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo Form::open(['url' => 'admin/edit_manage_fare/'.$result->id, 'class' => 'form-horizontal','id' => 'manage_peak_fare_form']); ?>

          <div class="box-body" ng-init="time_options=<?php echo e(json_encode($time_options)); ?>;day_options=<?php echo e(json_encode($day_options)); ?>;">
            <span class="text-danger">(*)Fields are Mandatory</span>
            <div class="form-group">
              <label for="input_location" class="col-sm-3 control-label">
                Location <em class="text-danger">*</em>
              </label>
              <div class="col-md-7 col-sm-offset-1" ng-init="location='<?php echo e(old('location','')); ?>'">
                <?php echo Form::select('location', $locations, $result->location_id, ['class' => 'form-control', 'id' => 'input_location','placeholder' => 'Select']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('vehicle_type', $vehicle_types, old('vehicle_type',$result->vehicle_id), ['class' => 'form-control', 'id' => 'input_vehicle_type','placeholder' => 'Select']); ?>

                <span class="text-danger"><?php echo e($errors->first('vehicle_type')); ?></span>
                <span class="text-danger"><?php echo e($errors->first('same_loc_error')); ?></span>
              </div>
            </div>
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('base_fare', $result->base_fare, ['class' => 'form-control', 'id' => 'input_base_fare', 'placeholder' => 'Base Fare']); ?>

                    <span class="text-danger"><?php echo e($errors->first('base_fare')); ?></span>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('capacity', $result->capacity, ['class' => 'form-control', 'id' => 'input_capacity', 'placeholder' => 'Capacity']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('min_fare',  $result->min_fare, ['class' => 'form-control', 'id' => 'input_min_fare', 'placeholder' => 'Minimum Fare']); ?>

                    <span class="text-danger"><?php echo e($errors->first('min_fare')); ?></span>
                  </div>
                </div>
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('per_min', $result->per_min, ['class' => 'form-control', 'id' => 'input_per_min', 'placeholder' => 'Per Minutes']); ?>

                    <span class="text-danger"><?php echo e($errors->first('per_min')); ?></span>
                  </div>
                </div>
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('per_km', $result->per_km, ['class' => 'form-control', 'id' => 'input_per_km', 'placeholder' => 'Per Kilometer']); ?>

                    <span class="text-danger"><?php echo e($errors->first('per_km')); ?></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('waiting_time', old('waiting_time',$result->waiting_time), ['class' => 'form-control', 'id' => 'input_waiting_time', 'placeholder' => 'Waiting Time']); ?>

                    <span class="text-danger"> <?php echo e($errors->first('waiting_time')); ?> </span>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('waiting_charge', old('waiting_charge',$result->waiting_charge), ['class' => 'form-control', 'id' => 'input_waiting_charge', 'placeholder' => 'Waiting Charge']); ?>

                    <span class="text-danger"> <?php echo e($errors->first('waiting_charge')); ?> </span>
                  </div>
                </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('schedule_fare', $result->schedule_fare, ['class' => 'form-control', 'id' => 'input_schedule_fare', 'placeholder' => 'Schedule Ride Fare']); ?>

                    <span class="text-danger"><?php echo e($errors->first('schedule_fare')); ?></span>
                  </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1" ng-init="apply_peak='<?php echo e(old('apply_peak',$result->apply_peak)); ?>'">
                <?php echo Form::select('apply_peak', array_merge([''=>'Select','Yes' =>'Yes','No' =>'No']),'', ['class' => 'form-control', 'id' => 'input_peak_fare','ng-model'=>'apply_peak']); ?>

                <span class="text-danger" ng-hide="apply_peak != ''"><?php echo e($errors->first('apply_peak')); ?></span>
                <span class="text-danger" ng-hide="apply_peak == 'Yes' || apply_night =='Yes'"><?php echo e($errors->first('not_fare')); ?></span>
              </div>
            </div>
            <div class="box-body fare-body" ng-show="apply_peak == 'Yes'">
              <div class="col-md-12 peak_fare_wrapper">
                <div class="panel panel-info">
                  ...
                  <div class="panel-body" ng-init="peak_fare_details = <?php echo e(json_encode(old('peak_fare_details') ?: $peak_fare_details)); ?>;errors = <?php echo e(json_encode($errors->getMessages())); ?>;removed_fares=''">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1" ng-init="apply_night='<?php echo e(old('apply_night',$result->apply_night)); ?>'">
                <?php echo Form::select('apply_night', array_merge([''=>'Select','Yes' =>'Yes','No' =>'No']), '', ['class' => 'form-control', 'id' => 'input_night_fare','ng-model'=>'apply_night']); ?>

                <span class="text-danger" ng-hide="apply_night != ''"><?php echo e($errors->first('apply_night')); ?></span>
              </div>
            </div>
            <div class="box-body fare-body" ng-show="apply_night == 'Yes'">
              <div class="col-md-12 night_fare_wrapper">
                <div class="panel panel-info">
                  ...
                  <div class="panel-body" ng-init="night_fare_details = <?php echo e(json_encode(old('night_fare_details') ?: $night_fare_details)); ?>;">
                    <div class="row">
          ...
          <div class="box-footer text-center">
            ...
            <a href="<?php echo e(url('admin/manage_fare')); ?>" class="btn btn-default" name="cancel" value="Cancel">
              Cancel
            </a>
          </div>
          <!-- /.box-footer -->
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seentec3/newtaxi.seentechs.com/resources/views/admin/manage_fare/edit.blade.php ENDPATH**/ ?>