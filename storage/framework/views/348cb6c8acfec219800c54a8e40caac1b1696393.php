  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Help Category</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <!-- <h3 class="box-title">Help Category Management</h3> -->
              <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url('admin/add_help_category')); ?>">Add Help Category</a></div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
