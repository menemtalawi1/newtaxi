				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paypal_id', old('paypal_id',payment_gateway('paypal_id','Paypal')), ['class' => 'form-control', 'id' => 'input_paypal_id', 'placeholder' => 'PayPal Id']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paypal_client', old('paypal_client',payment_gateway('client','Paypal')), ['class' => 'form-control', 'id' => '', 'placeholder' => 'PayPal Client']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paypal_secret', old('paypal_secret',payment_gateway('secret','Paypal')), ['class' => 'form-control', 'id' => '', 'placeholder' => 'PayPal Secret']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('paypal_access_token', old('paypal_access_token',payment_gateway('access_token','Paypal')), ['class' => 'form-control', 'id' => 'accessToken', 'placeholder' => 'PayPal Access Token']); ?>
						...
						<div class="box-body" ng-init="stripe_enabled=<?php echo e(old('stripe_enabled',payment_gateway('is_enabled','Stripe'))); ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('stripe_publish_key', old('stripe_publish_key',payment_gateway('publish','Stripe')), ['class' => 'form-control', 'id' => 'input_stripe_publish_key', 'placeholder' => 'Stripe Key']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('stripe_secret_key', old('stripe_secret_key',payment_gateway('secret','Stripe')), ['class' => 'form-control', 'id' => 'input_stripe_secret_key', 'placeholder' => 'Stripe Secret']); ?>
					...
					<div class="box-body" ng-init="bt_enabled=<?php echo e(old('bt_enabled',payment_gateway('is_enabled','Braintree'))); ?>">
						<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::select('bt_enabled', array('0' => 'No', '1' => 'Yes'), old('bt_enabled',payment_gateway('is_enabled','Braintree')), ['class' => 'form-control', 'id' => 'input_bt_enabled','ng-model' => 'bt_enabled']); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('bt_merchant_id', old('bt_merchant_id',payment_gateway('merchant_id','Braintree')), ['class' => 'form-control', 'id' => 'input_merchant_id', 'placeholder' => 'Merchant ID']); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('merchant_account_id', old('merchant_account_id', payment_gateway('merchant_account_id','Braintree')), ['class'=>'form-control', 'id'=>'input_merchant_account_id', 'placeholder'=>'Braintree Merchant Account Id']); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('bt_public_key', old('bt_public_key',payment_gateway('public_key','Braintree')), ['class' => 'form-control', 'id' => 'input_bt_public', 'placeholder' => 'Public Key']); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('bt_private_key', old('bt_private_key',payment_gateway('private_key','Braintree')), ['class' => 'form-control', 'id' => 'input_bt_private_key', 'placeholder' => 'Private Key']); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('tokenization_key', old('tokenization_key',payment_gateway('tokenization_key','Braintree')), ['class'=>'form-control', 'id'=>'input_tokenization_key', 'placeholder'=>'Braintree Tokenization Key']); ?>
					...
					<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<input type="checkbox" name="is_web_payment" id="is_web_payment" value="1" <?php echo e(old('is_web_payment',payment_gateway('is_web_payment','Common')) ==1 ? 'checked':''); ?> > 
							</div>
						</div>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cloneapp/public_html/cabme.cloneappsolutions.com/resources/views/admin/payment_gateway.blade.php ENDPATH**/ ?>