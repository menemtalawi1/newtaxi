    ...
    <body>
        <table class="table table-bordered table-condensed">
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(is_string($value) || trim($value)==='' || is_numeric($value)): ?>
...
<?php /**PATH /home/seentec3/newtaxi.seentechs.com/resources/views/vendor/datatables/print.blade.php ENDPATH**/ ?>