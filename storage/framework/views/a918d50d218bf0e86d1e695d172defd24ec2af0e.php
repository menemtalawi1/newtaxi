<aside class="main-sidebar">
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<?php if(@$user->can('manage_banner')): ?>
			<li class="<?php echo e((Route::current()->uri() == 'admin/banner') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/banner')); ?>"><i class="fa fa-cog"></i><span>Manage Banners</span></a></li>
			<?php endif; ?>
...
<?php /**PATH C:\xampps\htdocs\new\resources\views/admin/common/navigation.blade.php ENDPATH**/ ?>