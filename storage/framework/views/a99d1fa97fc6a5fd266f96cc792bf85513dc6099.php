<aside class="main-sidebar">
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li class="<?php echo e((Route::current()->uri() == 'admin/documents') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/documents')); ?>"><i class="fa fa-users"></i><span>Manage Documents</span></a></li>
			<?php endif; ?>
			...
			<?php if(@$user->can('view_vehicle_make')): ?>
				<li class="<?php echo e((Route::current()->uri() == 'admin/vehicle_make' || Route::current()->uri() == 'admin/add-vehicle-make' || Route::current()->uri() == 'admin/edit-vehicle-make/{id}') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/vehicle_make')); ?>"><i class="fa fa fa-car"></i><span>Vehicle Make</span></a></li>
			<?php endif; ?>

			<?php if(@$user->can('view_vehicle_model')): ?>
				<li class="<?php echo e((Route::current()->uri() == 'admin/vehicle_model' || Route::current()->uri() == 'admin/add-vehicle_model' || Route::current()->uri() == 'admin/edit-vehicle_model/{id}') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/vehicle_model')); ?>"><i class="fa fa fa-car"></i><span>Vehicle Model</span></a></li>
			<?php endif; ?>
			...
			<li class="treeview <?php echo e((Route::current()->uri() == 'admin/vehicle_type' || Route::current()->uri() == $first_segment.'/vehicle') ? 'active' : ''); ?>">
				<a href="#">
					<i class="fa fa-taxi"></i>
					<span> Manage Vehicles Type </span><i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
					<?php if($company_user || @$user->can('manage_vehicle')): ?>
					<li class="<?php echo e((Route::current()->uri() == $first_segment.'/vehicle') ? 'active' : ''); ?>"><a href="<?php echo e(url($first_segment.'/vehicle')); ?>"><i class="fa fa-taxi"></i><span>Vehicles</span></a></li>
					<?php endif; ?>
					<?php if(@$user->can('manage_vehicle_type')): ?>
					<li class="<?php echo e((Route::current()->uri() == 'admin/vehicle_type') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/vehicle_type')); ?>"><i class="fa fa-car"></i><span>Vehicles Types</span></a></li>
					<?php endif; ?>
				</ul>
			</li>
			<?php endif; ?>
			...
			<li class="<?php echo e((Route::current()->uri() == 'admin/cancel-reason') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/cancel-reason')); ?>"><i class="fa fa fa-ban"></i><span>Manage Cancel Reason</span></a></li>
			<?php endif; ?>
...
<?php /**PATH /home/cloneapp/public_html/cabme.cloneappsolutions.com/resources/views/admin/common/navigation.blade.php ENDPATH**/ ?>