      ...
      <div class="soft-tiny clearfix" data-reactid="11">
         <div data-reactid="12">
            <form class="push--top-small forward" method="POST" data-reactid="13">
               <input type="hidden" name="user_type" value="Rider" id="users_type">
               <div data-reactid="15" class="email_phone-sec">
                  <h4 data-reactid="14"><?php echo e(trans('messages.header.authorize_deletion')); ?></h4>
