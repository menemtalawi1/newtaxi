      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <?php echo Form::open(['url' => 'admin/add_role', 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('display_name', '', ['class' => 'form-control', 'id' => 'input_display_name', 'placeholder' => 'Display Name']); ?>
                ...
                <div class="form-group">
                  ...
                  <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="checkbox" style="display: inline-block;">
                      <label>
                        <input type="checkbox" class="permission_check" name="permission[]" value="<?php echo e($row->id); ?>" style="position: relative !important;"><span><?php echo e($row->display_name); ?></span>
                      </label>
                    </li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seentec3/newtaxi.seentechs.com/resources/views/admin/roles/add.blade.php ENDPATH**/ ?>