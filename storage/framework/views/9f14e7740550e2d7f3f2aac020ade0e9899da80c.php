        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item <?php echo e(isActive('LaravelInstaller::settings')); ?>">
                        <?php if(Request::is('install/settings') ): ?>
                            <a href="<?php echo e(route('LaravelInstaller::settings')); ?>">
                    ...
                    <li class="step__item <?php echo e(isActive('LaravelInstaller::environment')); ?> <?php echo e(isActive('LaravelInstaller::environmentWizard')); ?> <?php echo e(isActive('LaravelInstaller::environmentClassic')); ?>">
                        <?php if(Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') || Request::is('install/settings') ): ?>
                    ...
                    <li class="step__item <?php echo e(isActive('LaravelInstaller::permissions')); ?>">
                        <?php if(Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') || Request::is('install/settings') ): ?>
                    ...
                    <li class="step__item <?php echo e(isActive('LaravelInstaller::requirements')); ?>">
                        <?php if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') || Request::is('install/settings') ): ?>
...
<?php /**PATH /home/cloneapp/public_html/cabme.cloneappsolutions.com/resources/views/vendor/installer/layouts/master.blade.php ENDPATH**/ ?>