  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/cancel-reason')); ?>">Cancel Reason</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open(['url' => 'admin/edit-cancel-reason/'.$result->id, 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('reason', old('value',$result->reason), ['class' => 'form-control', 'id' => 'input_reason', 'placeholder' => 'Value']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::select('cancelled_by', array('Rider' => 'Rider', 'Driver' => 'Driver', 'Admin' => 'Admin', 'Company' => 'Company'), old('cancelled_by',$result->cancelled_by), ['class' => 'form-control', 'id' => 'input_cancelled_by', 'placeholder' => 'Select']); ?>

                    <span class="text-danger"><?php echo e($errors->first('cancelled_by')); ?></span>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::select('status', array('Active' => 'Active', 'Inactive' => 'Inactive'), old('status',$result->status), ['class' => 'form-control', 'id' => 'input_status', 'placeholder' => 'Select']); ?>
          ...
          <div class="panel" ng-init="translations = <?php echo e(json_encode(old('translations') ?: @$result->translations)); ?>; removed_translations =  []; errors = <?php echo e(json_encode($errors->getMessages())); ?>; " ng-cloak>
                        ...
                        <div class="col-md-7 col-sm-offset-1">
                          <div class="form-group">
                            <select name="translations[{{$index}}][locale]" class="form-control" id="input_language_{{$index}}" ng-model="translation.locale" >
                                ...
                                <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $translation_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($key); ?>" ng-if="(('<?php echo e($key); ?>' | checkKeyValueUsedInStack : 'locale': translations) || '<?php echo e($key); ?>' == translation.locale) && '<?php echo e($key); ?>' != 'en'"><?php echo e($translation_data); ?></option>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7 col-sm-offset-1">
                        <div class="form-group">
                        <?php echo Form::text('translations[{{$index}}][reason]', '{{translation.reason}}', ['class' => 'form-control', 'id' => 'input_reason_{{$index}}', 'placeholder' => 'Name']); ?>
