        ...
        <div class="box">
          <div class="box-header">
            ...
            <div style="float:right;">
              <a class="btn btn-success" href="<?php echo e(url('admin/add_support')); ?>">Add Support</a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cloneapp/public_html/cabme.cloneappsolutions.com/resources/views/admin/support/view.blade.php ENDPATH**/ ?>