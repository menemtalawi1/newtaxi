...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(url('admin/manage_fare')); ?>">manage Fare</a></li>
    ...
    <div class="row" ng-cloak>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo Form::open(['url' => 'admin/add_manage_fare', 'class' => 'form-horizontal']); ?>
          ...
          <div class="box-body" ng-init="time_options=<?php echo e(json_encode($time_options)); ?>;day_options=<?php echo e(json_encode($day_options)); ?>;">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1" ng-init="location='<?php echo e(old('location','')); ?>'">
                <?php echo Form::select('location', $locations, '', ['class' => 'form-control', 'id' => 'input_location']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1" ng-init="vehicle_type='<?php echo e(old('vehicle_type','')); ?>'">
                <?php echo Form::select('vehicle_type', $vehicle_types, '', ['class' => 'form-control', 'id' => 'input_vehicle_type']); ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('base_fare', '', ['class' => 'form-control', 'id' => 'input_base_fare', 'placeholder' => 'Base Fare']); ?>
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('capacity', '', ['class' => 'form-control', 'id' => 'input_capacity', 'placeholder' => 'Capacity']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('min_fare', '', ['class' => 'form-control', 'id' => 'input_min_fare', 'placeholder' => 'Minimum Fare']); ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('per_min', '', ['class' => 'form-control', 'id' => 'input_perkm', 'placeholder' => 'Per Minutes']); ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('per_km', '', ['class' => 'form-control', 'id' => 'input_perkm', 'placeholder' => 'Per Kilometer']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('waiting_time', old('waiting_time',''), ['class' => 'form-control', 'id' => 'input_waiting_time', 'placeholder' => 'Waiting Time']); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('waiting_charge', old('waiting_charge',''), ['class' => 'form-control', 'id' => 'input_waiting_charge', 'placeholder' => 'Waiting Charge']); ?>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('schedule_fare', '', ['class' => 'form-control', 'id' => 'input_schedule_fare', 'placeholder' => 'Schedule Ride Fare']); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1" ng-init="apply_peak='<?php echo e(old('apply_peak','')); ?>'">
            ...
            <div class="box-body fare-body" ng-show="apply_peak == 'Yes'">
              <div class="col-md-12 peak_fare_wrapper">
                <div class="panel panel-info">
                  ...
                  <div class="panel-body" ng-init="peak_fare_details = <?php echo e(json_encode(old('peak_fare_details') ?: array(0=>[]))); ?>;errors = <?php echo e(json_encode($errors->getMessages())); ?>;removed_fares=''">
                    <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1" ng-init="apply_night='<?php echo e(old('apply_night','')); ?>'">
            ...
            <div class="box-body fare-body" ng-show="apply_night == 'Yes'">
              <div class="col-md-12 night_fare_wrapper">
                <div class="panel panel-info">
                  ...
                  <div class="panel-body" ng-init="night_fare_details = <?php echo e(json_encode(old('night_fare_details') ?: array())); ?>;errors = <?php echo e(json_encode($errors->getMessages())); ?>;">
                    <div class="row">
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cloneapp/public_html/cabme.cloneappsolutions.com/resources/views/admin/manage_fare/add.blade.php ENDPATH**/ ?>