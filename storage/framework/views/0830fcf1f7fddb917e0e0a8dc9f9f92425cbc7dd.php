        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <!-- <h3 class="box-title">Currency Management</h3> -->
              <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url('admin/add_currency')); ?>">Add Currency</a></div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
