        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('owner', array('Rider' => 'Rider', 'Driver' => 'Driver','All' => 'All'), '', ['class' => 'form-control', 'id' => 'input_owner', 'placeholder' => 'Select']); ?>
