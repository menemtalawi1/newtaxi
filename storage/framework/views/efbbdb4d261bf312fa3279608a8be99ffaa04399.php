        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div style="float:right;"><a class="btn btn-success" href="<?php echo e(url('admin/add_promo_code')); ?>">Add Promo Code</a></div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
