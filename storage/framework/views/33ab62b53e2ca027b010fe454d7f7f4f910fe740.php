...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 flexbox__item four-fifths page-content" ng-controller="payout_preferences">
		  <div class="separated--bottom  text--left">
                <h1 class="cls_profiletitle"><?php echo app('translator')->get('messages.account.payout_methods'); ?>  </h1>
            </div>
	<main id="site-content" role="main">
		<div class="row-space-top-4 row-space-4">
			<div class="row">
				<div class="col-md-12">
					<div class="payout_setup" ng-init="payouts=<?php echo e($payouts); ?>">
												...
												<td class="payout-options" >
													<li class="dropdown-trigger list-unstyled" ng-hide="payout.is_default">
														...
														<ul data-sticky="true" data-trigger="#payout-options-{{ payout.id }}" class="tooltip tooltip-top-left list-unstyled dropdown-menu" aria-hidden="true">
															<li>
																<a rel="nofollow" data-method="post" class="link-reset menu-item" href="<?php echo e(route('payout_delete',['id' => '/'])); ?>/{{payout.id}}"> <?php echo app('translator')->get('messages.account.remove'); ?> </a>
															</li>
															<li>
																<a rel="nofollow" data-method="post" class="link-reset menu-item" href="<?php echo e(route('payout_default',['id' => '/'])); ?>/{{payout.id}}"> <?php echo app('translator')->get('messages.account.set_default'); ?> </a>
															</li>
														</ul>
													</li>
												</td>
										...
										<tr id="add_payout_method_section">
											<td colspan="4">
												...
												<span class="text-muted lang-left">
													<?php echo app('translator')->get('messages.account.direct_deposit'); ?>, <span>PayPal, </span><span class="lang-left">etc...</span>
												</span>
											</td>
										</tr>
										</tfoot>
		...
		<div id="modal-add-payout-set-address" class="modal-content">
			...
			<div class="flash-container" ng-show="show_address_error">
				<div class="alert alert-danger">
					...
					<p class="text-danger" ng-show="address_error"> <?php echo app('translator')->get('messages.account.blank_address'); ?> </p>
					<p class="text-danger" ng-show="city_error"> <?php echo app('translator')->get('messages.account.blank_city'); ?> </p>
					<p class="text-danger" ng-show="country_error"> <?php echo app('translator')->get('messages.account.blank_country'); ?> </p>
					<p class="text-danger" ng-show="postal_error"> <?php echo app('translator')->get('messages.account.blank_post'); ?> </p>
				</div>
			</div>
			...
			<div class="panel-body">
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<div class="select" ng-init="country=''">
							<?php echo Form::select('country_dropdown', $country,  old('country',$default_country), ['autocomplete' => 'billing country', 'id' => 'payout_info_payout_country', 'class' => 'form-control', "ng-model" => "country", "ng-change" => "countryChanged()","placeholder" => "Select"]); ?>
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<?php echo Form::text('address1', '', ['id' => 'payout_info_payout_address1', 'class' => 'form-control', 'ng-model'=>"address1"]); ?>
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<?php echo Form::text('address2', '', ['id' => 'payout_info_payout_address2', 'class' => 'form-control', 'ng-model'=>"address2"]); ?>
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<?php echo Form::text('city', '', ['id' => 'payout_info_payout_city','ng-model'=>"city" , 'class' => 'form-control']); ?>
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<?php echo Form::text('state', old('state'), ['id' => 'payout_info_payout_state','ng-model'=>"state", 'class' => 'form-control']); ?>
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<?php echo Form::text('postal_code', '', ['id' => 'payout_info_payout_zip','ng-model' => 'postal_code' , 'class' => 'form-control']); ?>
	...
	<div class="modal poppayout perferenace_payout pl-0" id="payout_popup-methods" aria-hidden="false" tabindex="-1">
		<div id="modal-add-payout-set-address" class="modal-content">
			...
			<div class="flash-container" ng-show="show_method_error">
				<div class="alert alert-danger">
					<a class="close alert-close" href="javascript:void(0);"><i class="icon alert-icon icon-alert-alt"></i> </a>
					<p class="text-danger" ng-show="method_error"> <?php echo app('translator')->get('messages.account.choose_method'); ?> </p>
				</div>
			</div>
	...
	<div class="modal poppayout" id="payout_popup-paypal" aria-hidden="false" tabindex="-1">
		<div id="modal-add-payout-set-address" class="modal-content">
			...
			<div class="flash-container" ng-show="show_paypal_error">
				<div class="alert alert-danger">
					<a class="close alert-close" href="javascript:void(0);"><i class="icon alert-icon icon-alert-alt"></i> </a>
					<p class="text-danger" ng-show="paypal_email_error"> <?php echo app('translator')->get('messages.account.valid_email'); ?> </p>
				</div>
			</div>
			<?php echo Form::open(['url' => route('update_payout_preference') ,'class' => 'modal-add-payout-pref', 'method' => 'POST', 'id' => 'payout_paypal']); ?>
	...
	<div class="modal poppayout" id="payout_popup-stripe" aria-hidden="false" tabindex="-1">
		<div id="modal-add-payout-set-address" class="modal-content">
			...
			<div class="flash-container" ng-show="show_paypal_error">
				<div class="alert alert-danger">
					<a class="close alert-close" href="javascript:void(0);"><i class="icon alert-icon icon-alert-alt"></i> </a>
					<p class="text-danger" ng-show="stripe_blank_error"> <?php echo app('translator')->get('messages.account.fill_all_required_fields'); ?> </p>
				</div>
			</div>
			<?php echo Form::open(['url' => route('update_payout_preference') ,'class' => 'modal-add-payout-pref', 'method' => 'POST', 'id' => 'payout_stripe', 'files' => 'true']); ?>
			...
			<div class="panel-body panel-body-payout" ng-init="payout_country=<?php echo e(json_encode(old('country') ?: '')); ?>;payout_currency=<?php echo e(json_encode(old('currency') ?: '')); ?>;iban_supported_countries = <?php echo e(json_encode($iban_supported_countries)); ?>;branch_code_required=<?php echo e(json_encode($branch_code_required)); ?>;country_currency=<?php echo e(json_encode($country_currency)); ?>;change_currency();mandatory=<?php echo e(json_encode($mandatory)); ?>;old_currency='<?php echo e(old('currency') ? json_encode(old('currency')) : ''); ?>';country_list=<?php echo e(json_encode($country_list)); ?>;">
				<div>
					...
					<div class="select">
						<?php echo Form::select('country', $country_list, $default_country, ['autocomplete' => 'billing country', 'id' => 'payout_info_payout_country1','placeholder'=>'Select','ng-model'=>'payout_country','ng-change' => 'changeCurrency()']); ?>
				...
				<div ng-show="mandatory[payout_country][2]">
					...
					<?php echo Form::text('branch_code', '', ['id' => 'branch_code', 'class' => 'form-control','maxlength'=>'4']); ?>
				...
				<div ng-if="payout_country">
					...
					<label for="account_number" ng-show="iban_supported_countries.includes(payout_country)  && payout_country != 'MX' "><?php echo e(trans('messages.account.iban_number')); ?><em class="text-danger">*</em></label>
				...
				<div ng-if="payout_country == 'JP'" class="col-md-6 col-sm-12 p-0 select-cls row-space-3">
					...
					<div class="select">
						<?php echo Form::select('gender', ['male' => trans('messages.profile.male'), 'female' => trans('messages.profile.female')], Auth::user()->gender, ['id' => 'user_gender', 'placeholder' => trans('messages.profile.gender'), 'class' => 'focus','style'=>'min-width:140px;']); ?>
	...
	<div class="modal poppayout" id="payout_popup-bank_transfer" aria-hidden="false" tabindex="-1">
		<div id="modal-add-payout-set-address" class="modal-content">
			...
			<div class="flash-container" ng-show="show_bank_error">
				<div class="alert alert-danger">
					<a class="close alert-close" href="javascript:void(0);"><i class="icon alert-icon icon-alert-alt"></i> </a>
					<p class="text-danger" ng-show="required_error"> <?php echo app('translator')->get('messages.account.fill_all_required_fields'); ?> </p>
				</div>
			</div>
			<?php echo Form::open(['url' => route('update_payout_preference') ,'class' => 'modal-add-payout-pref', 'method' => 'POST', 'id' => 'payout_bank_transfer']); ?>
...
<script type="text/javascript">
	let payout_errors = <?php echo count($errors->getMessages()); ?>;
	let payout_method = '<?php echo old("payout_method"); ?>';
	if(payout_errors > 0 && '<?php echo e(Auth::user()->company_id <= 1); ?>' && payout_method != '') {
		$('#payout_popup-'+payout_method).modal('show');
	}
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('template_driver_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\newtaxi\resources\views/driver_dashboard/payout_preferences.blade.php ENDPATH**/ ?>