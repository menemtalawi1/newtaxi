...
<div bgcolor="#5498c4" style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif;color:#565a5c;min-height:100%;background-color:#f7f7f7;font-size:16px;line-height:150%;width:100%!important">
...
<table border="0" cellpadding="0" cellspacing="0" style="border:none;border-collapse:collapse;border-spacing:0;max-width:700px;width:100%">
  <tbody><tr>
    <td bgcolor="#62CEAD" valign="bottom" background="<?php echo e(url('images/email_background.jpg')); ?>" style="background-size:cover;background-image:url('images/email_background.jpg')" align="center">
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="border:none;border-collapse:collapse;border-spacing:0;width:100%">
        <tbody><tr>
          ...
          <td style="padding:0;margin:0;width:13%" align="center">
            <table border="0" cellpadding="0" cellspacing="0" style="border:none;border-collapse:collapse;border-spacing:0;width:100%">
              <tbody><tr>
                <td style="background-color:#000000"><img src="<?php echo e(url('images/logo.png')); ?>" width="96" height="" border="0" class=" " style="clear:both;display:block;height:auto;max-height:90px;max-width:96px;min-width:65px;outline:none;text-decoration:none;width:100%"></td>
              </tr>
            </tbody></table>
          </td>
          <td style="padding:0;margin:0;width:6%;min-width:15px" align="center"></td>
...
<?php /**PATH C:\xampps\htdocs\newtaxi\resources\views/emails/common/header.blade.php ENDPATH**/ ?>