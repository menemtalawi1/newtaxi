  ...
  <div class="fixed-header" id=header>
    <div class="container">
      ...
      <ul  class="header-left-link">
        <li><a href="<?php echo e(url('signup_rider')); ?>"><?php echo e(trans('messages.footer.ride')); ?></a></li>
      ...
      <div class="pull-right">
        ...
        <ul class="header-right-link">
          ...
          <?php else: ?>
          <li>
            <a href="<?php echo e(@Auth::user()->user_type == 'Rider' ? url('profile') : url('driver_profile')); ?>"><?php echo e(@Auth::user()->first_name); ?> <?php echo e(@Auth::user()->last_name); ?></a></li>
          ...
          <div class="nav-div">
           ...
           <p class="head-logo pull-left menu_head"><img src="<?php echo e($logo_url); ?>"></p>
...
<?php /**PATH /home/cloneapp/public_html/cabme.cloneappsolutions.com/resources/views/common/header.blade.php ENDPATH**/ ?>