...
<div style="padding: 10px;width: 100%;margin: 0 auto;display: inline-block;">
    <div ><h1><?php echo app('translator')->get('messages.dashboard.trip_invoice'); ?></h1>
    </div>
    <div >
        <table >
            <thead >
                <tr>
                    <th><?php echo app('translator')->get('messages.dashboard.invoice_no'); ?></th>
                    <th ><?php echo app('translator')->get('messages.dashboard.trip_date'); ?></th>
                    <th><?php echo app('translator')->get('messages.dashboard.invoice'); ?></th>
                </tr>
            </thead>
            <tbody>
                <tr  >
                    ...
                    <td data-title="Invoice"><?php echo e($trip->currency->original_symbol); ?>  <?php echo e($trip->company_driver_earnings); ?></td>
                </tr>
            </tbody>
        </table>
        <table class="no-border">
            <tr>
                <td class="width-60" style="text-align: center;">
                    <div class="" style="background-image: url(<?php echo e($trip->rider_profile_picture); ?>);height: 150px;width: 150px;margin: 0 auto;background-size: cover;background-position: center center;background-repeat: no-repeat;"></div>
                </td>
                <td class="width-40">
                    <div class="col-sm-6">
                        <p><?php echo app('translator')->get('messages.dashboard.invoice_issued'); ?> <?php echo e($site_name); ?> <?php echo app('translator')->get('messages.dashboard.behalf'); ?></p>
                        <p><?php echo e($trip->rider_name); ?><br>
...
<?php echo $__env->make('template_without_header_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampps\htdocs\newtaxi\resources\views/dashboard/download_invoice.blade.php ENDPATH**/ ?>