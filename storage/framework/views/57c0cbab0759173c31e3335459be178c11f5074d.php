                ...
                <div class="grid">
                    <div class="drive-trip-filter">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 palm-one-whole black-form trip-form" >
                            ...
                            <input type="radio" id="month-<?php echo e(date('Y-m', strtotime('-1 month'))); ?>-radio" name="month" value="<?php echo e(date('Y-m', strtotime('-1 month'))); ?>" class="hidden">
                            <label style="cursor: pointer;" for="month-<?php echo e(date('Y-m', strtotime('-1 month'))); ?>-radio" value="<?php echo e(date('Y-m', strtotime('-1 month'))); ?>" class="btn-input btn--uniform push--right month-filter" month="<?php echo e(date('F', strtotime('-1 month'))); ?>"><?php echo e(date('F', strtotime('-1 month'))); ?></label>
                            <input type="radio" id="month-<?php echo e(date('Y-m', strtotime('-2 month'))); ?>-radio" name="month" value="<?php echo e(date('Y-m', strtotime('-2 month'))); ?>" class="hidden">
                            <label style="cursor: pointer;"   for="month-<?php echo e(date('Y-m', strtotime('-2 month'))); ?>-radio" value="<?php echo e(date('Y-m', strtotime('-2 month'))); ?>" class="btn-input btn--uniform push--right month-filter" month="<?php echo e(date('F', strtotime('-2 month'))); ?>"><?php echo e(date('F', strtotime('-2 month'))); ?></label>
                        </div>
                    </div>
