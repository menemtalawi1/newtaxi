...
<div class="manual-booking content-wrapper" ng-controller='manual_booking' ng-init="vehicle_types = <?php echo e($vehicle_types); ?>">
	...
	<?php echo Form::open(['method'=>'POST','url' => LOGIN_USER_TYPE.'/manual_booking/store', 'class' => 'form-horizontal manual_booking','id'=>'manual_booking','name'=>'myForm']); ?>

	<section class="content">
		<div class="box box-info" style="padding: 3rem"> 
		<?php echo Form::hidden('manual_booking_id', @$schedule_ride->id, ['id' => 'manual_booking_id']); ?>

		<?php echo Form::hidden('auto_assign_id', @$schedule_ride->driver_id, ['id' => 'auto_assign_id']); ?>

		<?php echo Form::hidden('utc_offset', '', ['id' => 'utc_offset']); ?>

		<?php echo Form::hidden('location_id', @$schedule_ride->location_id, ['id' => 'location_id']); ?>

		<?php echo Form::hidden('peak_id', @$schedule_ride->peak_id, ['id' => 'peak_id']); ?>

		<h4>Manual Taxi Dispatch</h4>
		<div class="row">
			<div class="col-md-2 cls_manualbook p-0" ng-init="country_code = <?php echo e(@$schedule_ride->users->country_code==null ? $country_code_option[0]->phone_code:@$schedule_ride->users->country_code); ?>">
				<select class ='form-control selectpicker' data-live-search="true" id="input_country_code" name='country_code' ng-model="country_code">
					...
					<option value="<?php echo e(@$country_code->phone_code); ?>" data-id="<?php echo e($country_code->id); ?>" <?php echo e(($country_code->id == (old('country_id')!=null? old('country_id') : '1')) ? 'selected' : ''); ?>><?php echo e($country_code->long_name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					<?php echo Form::hidden('country_id', old('country_id'), array('id'=>'country_id')); ?>

				</select>
				<span class="text-danger error_msg"><?php echo e($errors->first('country_code')); ?></span>
			</div>
			<div class="col-md-2 number-field">
				...
				<div class="col-md-7 col-lg-8">
					<?php echo Form::text('mobile_number', @$schedule_ride->users->mobile_number, ['class' => 'form-control', 'id' => 'input_mobile_number', 'placeholder' => 'Phone No', 'autocomplete' => 'off']); ?>

					<span class="text-danger error_msg"><?php echo e($errors->first('mobile_number')); ?></span>
				</div>
			</div>
			<div class="col-md-6 form-group m-0">
				<div class="col-md-3 form-group m-0 p-1">
					<?php echo Form::text('first_name', @$schedule_ride->users->first_name, ['class' => 'form-control', 'id' => 'input_first_name', 'placeholder' => 'First Name', 'autocomplete' => 'off']); ?>

					<span class="text-danger error_msg"><?php echo e($errors->first('first_name')); ?></span>
				</div>
				<div class="col-md-3 form-group m-0 p-1">
					<?php echo Form::text('last_name', @$schedule_ride->users->last_name, ['class' => 'form-control', 'id' => 'input_last_name', 'placeholder' => 'Last Name', 'autocomplete' => 'off']); ?>

					<span class="text-danger error_msg"><?php echo e($errors->first('last_name')); ?></span>
				</div>
				<div class="col-md-3 form-group m-0 p-1">
					<?php echo Form::text('email', @$schedule_ride->users->email, ['class' => 'form-control', 'id' => 'input_email', 'placeholder' => 'Email', 'autocomplete' => 'off']); ?>

					<span class="text-danger error_msg"><?php echo e($errors->first('email')); ?></span>
				</div>
				<div class="col-md-3 form-group m-0 p-1">
		...
		<div class="clearfix">
			<div class="col-md-4 location-form">
				<div class="row pick-location clearfix">
					<div class="col-md-12" ng-init='pickup_latitude = "<?php echo e(@$schedule_ride->pickup_latitude); ?>"'>
						<?php echo Form::hidden('pickup_latitude', @$schedule_ride->pickup_latitude, ['id' => 'pickup_latitude']); ?>

						<?php echo Form::hidden('pickup_longitude', @$schedule_ride->pickup_longitude, ['id' => 'pickup_longitude']); ?>

						<?php echo Form::text('pickup_location', @$schedule_ride->pickup_location, ['class' => 'form-control change_field', 'id' => 'input_pickup_location', 'placeholder' => 'Pick Up Location', 'autocomplete' => 'off']); ?>

						<span class="text-danger error_msg error_pickup_location"><?php echo e($errors->first('pickup_location')); ?></span>
					</div>
				</div>
				<div class="row pick-location clearfix">
					<div class="col-md-12">
						<?php echo Form::hidden('drop_latitude', @$schedule_ride->drop_latitude, ['id' => 'drop_latitude']); ?>

						<?php echo Form::hidden('drop_longitude', @$schedule_ride->drop_longitude, ['id' => 'drop_longitude']); ?>


						<?php echo Form::text('drop_location', @$schedule_ride->drop_location, ['class' => 'form-control change_field', 'id' => 'input_drop_location', 'placeholder' => 'Drop Off Location', 'autocomplete' => 'off']); ?>

						<span class="text-danger error_msg error_drop_location"><?php echo e($errors->first('drop_location')); ?></span>
					</div>
				</div>
				<div class="row clearfix">
					<div class="col-md-12" ng-init='date_time = "<?php echo e(@$schedule_ride->schedule_date); ?> <?php echo e(@$schedule_ride->schedule_time); ?>"'>
						<?php echo Form::text('date_time',(@$schedule_ride->schedule_date==null)?'':@$schedule_ride->schedule_date.' '.@$schedule_ride->schedule_time, ['class' => 'form-control change_field', 'id' => 'input_date_time', 'placeholder' => 'Select Date/Time Location','ng-cloak','disabled'=>isset($schedule_ride->id)?false:true]); ?>

						<span class="text-danger error_msg"></span>
					</div>
				</div>
				<div class="row clearfix" ng-init="vehicle_type_value = '<?php echo e(@$schedule_ride->car_id); ?>'">
					<div class="col-md-12">
						<select class='form-control change_field' ng-cloak placeholder ='Select Vehicle Type' name="vehicle_type" id="input_vehicle_type" ng-model="vehicle_type_value" ng-change="list_driver()" disabled >
							...
							<option ng-repeat="(key,vehicle_type) in vehicle_types" value="{{vehicle_type.id}}" key={{key}} <?php if(isset($schedule_ride->id)): ?> ng-selected="{{key}} == {{vehicle_type_value}}" <?php endif; ?> >{{vehicle_type.car_name}}</option>
						</select>
						<span class="text-danger error_msg error_vehicle_type"></span>
					</div>
				</div>
				<div class="row clearfix" ng-init="auto_assign_status = <?php echo e((@$schedule_ride->driver_id==0 && @$schedule_ride->id != '')?'true':'false'); ?>">
					<div class="col-md-12">
				...
				<div class="row clearfix">
					<div class="col-md-12">
						<?php echo Form::text('search_driver', '', ['class' => 'form-control', 'id' => 'input_search_driver', 'placeholder' => 'Type driver name to search from below list','ng-model'=>'search_driver']); ?>
					...
					<div style="display: none;" class="driver_list">
						<div class="row clearfix" ng-repeat="driver in drivers | filter:Driverfilter(search_driver) | filter:{ driver_current_status: driver_availability }">
							<span class="driver_detail_view" id={{driver.id}} first_name={{driver.first_name}} last_name={{driver.last_name}} phone={{driver.mobile_number}} email={{driver.email}} company={{driver.company}}> 
								<a href="<?php echo e(url(LOGIN_USER_TYPE.'/edit_driver')); ?>/{{driver.id}}" target="_blank" style="color: black">
									<div class="col-md-3">
					...
					<div>
						...
						<div class="clearfix">
							...
							<div class="col-md-6" ng-init="driver_availability = ''">
								...
								<span class="text-danger error_msg"><?php echo e($errors->first('driver_availability')); ?></span>
							</div>
						</div>
						<div class="clearfix map_zoom_level">
							...
							<div class="col-md-6" ng-init="map_radius=0">
								...
								<span class="text-danger error_msg"><?php echo e($errors->first('map_zoom')); ?></span>
							</div>
						</div>
					</div>
					...
					<div class="fare-table clearfix">
						...
						<div class="row">
							...
							<div class="col-md-4" ng-cloak>
								<?php echo e($currency_symbol); ?>{{vehicle_detail_minimum_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								<?php echo e($currency_symbol); ?>{{vehicle_detail_base_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								<?php echo e($currency_symbol); ?>{{vehicle_detail_km_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								<?php echo e($currency_symbol); ?>{{vehicle_detail_min_fare | number: 2}}
							</div>
						</div>
						<div class="row">
							<div class="col-md-8">
							...
							<div class="col-md-4" ng-cloak>
								<?php echo e($currency_symbol); ?>{{(vehicle_detail_peak_fare) | number: 2}}
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4" ng-cloak>
								<?php echo e($currency_symbol); ?>{{vehicle_detail_total_fare | number: 2}}
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	var old_edit_date = "<?php echo e(isset($schedule_ride->id)?@$schedule_ride->schedule_date.' '.@$schedule_ride->schedule_time:''); ?>";
	var page = "<?php echo e(isset($schedule_ride->id)?'edit':'new'); ?>";
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7\htdocs\newtaxi\resources\views/admin/manual_booking/index.blade.php ENDPATH**/ ?>