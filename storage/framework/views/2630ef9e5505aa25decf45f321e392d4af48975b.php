...
<div class="mini-green ride-mini-green" >
    <div href="#" class="_style_4jQAPw green-mini-div" style="width: 206px; padding: 32px 20px 20px 32px; display: block; position: relative; height: 206px; background-color: #FFC107">
...
<div class="col-lg-11 col-md-11 col-sm-12 col-xs-12" id="pad-sm-zero">
   <div id="mySliderTabsContainer" style="   margin-top: 25px;">
            ...
            <div id="mySliderTabs">
              <ul>
                <li><a href="#CabmeGO"><?php echo e(trans('messages.ride.economy')); ?></a></li> 
                <li><a href="#CabmeX"><?php echo e(trans('messages.ride.premium')); ?></a></li> 
                <li><a href="#CabmeXL"><?php echo e(trans('messages.ride.accessibility')); ?></a></li> 
              </ul>
              <div id="CabmeGO">
...
<?php echo $__env->make('templatesign', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seentec3/newtaxi.seentechs.com/resources/views/ride/ride.blade.php ENDPATH**/ ?>