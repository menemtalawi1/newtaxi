...
<body ng-app="App" class="<?php echo e((!isset($exception)) ? (Route::current()->uri() == '/' ? 'homepage' : '') : ''); ?> commonpage"><?php /**PATH C:\xampp7\htdocs\newtaxi\resources\views/common/head.blade.php ENDPATH**/ ?>