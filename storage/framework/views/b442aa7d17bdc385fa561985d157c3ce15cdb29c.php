        ...
        <div class="box box-info">
          ...
          <?php echo Form::open(['url' => LOGIN_USER_TYPE.'/edit_support/'.$result->id, 'class' => 'form-horizontal','files' => true]); ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <?php echo Form::select('owner', array('Rider' => 'Rider', 'Driver' => 'Driver','All' => 'All'), $result->owner, ['class' => 'form-control', 'id' => 'input_owner', 'placeholder' => 'Select']); ?>
