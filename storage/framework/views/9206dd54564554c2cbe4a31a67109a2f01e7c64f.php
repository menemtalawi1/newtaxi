      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header" style="height: 54px;">
            <!-- <h3 class="box-title">Manage Company <?php echo e($sub_title); ?></h3> -->
          </div>
          <!-- /.box-header -->
          <div class="box-body">
