...
<div class="content-wrapper" ng-controller="driver_management">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/banner')); ?>">Banner</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <?php echo Form::open(['url' => LOGIN_USER_TYPE.'/edit_banner/'.$result->id, 'class' => 'form-horizontal','files' => true]); ?>
          ...
          <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                ...
                <br>
                <img style="width:100px" src="<?php echo e(url('images/banner/'.$result->image)); ?>">
              </div>
            </div>
          </div>
