				...
				<div class="box box-info">
					...
					<!--	<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('copyright_year', old('copyright_year',site_settings('copyright_year')), ['class' => 'form-control', 'id' => 'input_head_code', 'placeholder' => 'Copyright year']) !!}
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								{!! Form::text('copyright_name', old('copyright_name',site_settings('copyright_name')), ['class' => 'form-control', 'id' => 'input_head_code', 'placeholder' => 'copyright name']) !!}
