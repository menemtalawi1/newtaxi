            ...
            <div class="col-lg-12 pad-0">
              <div class="col-lg-7 cls_lefttextin">
                <div class="cls_lefttext">
                  ...
                  <p>{{trans('messages.user.drive_with_Cabme')}} {{$site_name}} {{trans('messages.user.need_partner_content')}}</p>
                </div>
              </div>
              <div class="col-lg-5 pad-0">
                  <div class="driverform">
                    ...
                    <div class="cls_createacc">
                      <input type="hidden" name="user_type" value="Company">
                        <a href="{{ url('signin_company')}}" class="btn btn--primary">
                  ...
                  <div class="col-lg-12">
                    ...
                    <button name="step" value="basics" class="btn btn--primary" id="submit-btn" ng-click="showPopup('{{$submit_method}}');" type="button"  style="width: 100%;"  >{{trans('messages.user.submit')}}
                    </button>
