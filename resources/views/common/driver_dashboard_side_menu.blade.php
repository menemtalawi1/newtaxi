                ...
                <ul class="site-nav">
                    <li class="soft--ends">
                        ...
                        <div class="text--center">
                            ...
                            <div style="font-size: 15px;color: #063870;font-weight: bold;line-height: 58px;">{{ @Auth::user()->first_name}} {{ @Auth::user()->last_name}}</div>
                    ...
                    <li  class="logout">
                        <a href="{{ url('deleteaccount')}}">{{trans('messages.header.delete')}}</a>
                    </li>
                </ul>
            </div>
