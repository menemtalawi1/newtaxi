...
return [
	...
	'home' => [
		'title' => 'Get there Your day belongs to you',
		'desc' => 'One tap and a car comes directly to you. Hop in—your driver knows exactly where to go. And when you get there, just step out. Payment is completely seamless.',
		'drivedesc' => 'Begin driving with :site_name, with exclusive rewards and earnings. Convenient at its best and safe for everyone at any time.',
		'drive_you1' => 'Book  For Your Immediate Cab',
		'goals1' => ' Our drivers are pure professionals and they make sure that the customers enjoy a safe and reliable ride. Our app also provides a perfect fare estimate to the customers depending on the distance that they have to travel.',
		'siginup' => 'Sign Up',
		'or' => 'Or',	
		'siginup_drive' => 'Sign Up as Driver',
		'siginup_company' => 'Sign Up as Company',
		'company' => 'Company',
		'company_history' => 'Find everything you need to track your success of your company.',
		'company_signin' => 'COMPANY LOGIN',
		'company_signup' => 'COMPANY SIGN UP',
		'become_company' => 'Register Company',
		'rider_acnt' => 'with your rider account.',
		'aggrement' => 'By proceeding, I agree that',
		'easy_way' => 'Safest & Easiest Way Around',
		...
		'anywhere' => 'Get Anywhere, Anytime',
		'anywhere_content' => 'Daily commute. Errand across town. Early morning travel. Late night drinks. Wherever you’re headed, count on NewTaxi for a ride—no reservations required.',
		...
		'goals' => ' is flexible and rewarding, helping drivers meet their career and financial goals without much straining.',
		...
		'now_arrive' => 'The Best Taxi Booking',
		'safe' => 'Now Accessible to Everyone',
		'helping' => 'Helping Drivers Financially',
		'city_with' => 'Driving with',
		'city_with_content' => ' offers credible and safe rides to the riders. With the corrupt free service offerings, one can easily earn a good amount of profit.',
		'safe_ride' => 'Secure And Safe Rides',
		'backseat' => 'The drivers at ',
		'designed' => ' are checked based on their criminal records and drug tests to make sure about the safety of the customers.',
		'fare' => 'fare estimator',
	...
	'header' =>[
		...
		'invoice' => 'Invoice',
		'signin' => 'Sign In',
		'authorize_deletion' => 'Authorize Deletion',
		'signin-delete' => 'Delete Account',
		'location' => 'Kochi',
	...
	'profile' =>[
		...
		'track_every' => 'Find everything you need to boost your success as a driver.',
		'driver_signin' => 'Driver Login',
		'driver_signup' => 'Driver Sign Up',
		'driver_proceed' => 'Proceed',
		'trip_history' => 'Manage your payment options, review trip history, and more.',
		'delete_rider' => 'To Complete Deletion of your Rider Account, Please, Click on The Proceed Button and Confirm with your Username and Password. Make Sure You have no Pending Trips or Balances.',
		'delete_driver' => 'To Complete Deletion of your Driver Account, Please, Click on The Proceed Button and Confirm with your Username and Password. Make Sure You have no Pending Trips or Balances.',
		'rider_signin' => 'Rider Login',
	...
	'drive' =>[
		...
		'every_turn' => 'Earn more fro your trips',
		'fare_start' => 'At NewTaxi, our trip fares start with a base amount, then increase with time and distance. And when demand is higher than normal, drivers earn more income.',
		...
		'sign_online' => 'Sign up on NewTaxi online',
		...
		'provide_you_need' => ', we’ll provide everything you need to be a success on the road.',
		'signup_now' => 'SIGN UP NOW',
		'about_app' => 'About NewTaxi App',
		...
		'ready_money' => 'Ready to make money? The first step is to register online.',
	...
	'user' => [
		...
		'drive_when_want_content' => 'Need to earn with your car ?',
		'imp_moments' => 'you’ve got freedom and flexibility to drive whenever you have time. Work at your own time, so you can be there for all of life’s most important moments.',
		'no_office' => 'No office, no boss.',
		'no_office_content' => 'Whether you’re supporting your family or saving for something big,',
		'freedom' => 'gives you the freedom to get behind the wheel when it makes sense for you. Choose when to drive, where you go, and who to drive.',
		'safe_reliable' => 'Safe, reliable and quick rides',
		'promo' => 'Promo Code',
