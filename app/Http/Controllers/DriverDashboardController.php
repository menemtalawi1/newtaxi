...
class DriverDashboardController extends Controller
{
    ...
    **/
    ...
    {
        $data['result'] = Auth::user();
        return view('driver_dashboard.deleteaccount',$data);
    }
    ...
    public function add_vehicle()
    {
        ...
        $data['documents'] = CheckDocument('Vehicle',Auth::user()->country_id);
    ...
    public function edit_vehicle(Request $request)
    {
        ...
        $vehicle_doc = CheckDocument('Vehicle',$user->country_id);
        if($vehicle_doc){
    ...
    public function update_vehicle(Request $request) {
        ...
        $user = User::find(Auth::id());
        $vehicle_doc = CheckDocument('Vehicle',Auth::user()->country_id);
        if($vehicle_id =='') {            
    ...
    */
    ...
    public function documents(Request $request) {
        ...
        $driver_doc = CheckDocument('Driver',$user->country_id);
        if($driver_doc){            
    ...
    **/
    ...
    public function destroy($id,Request $request)
    {
        ...
        $driver_owe_amount = DriverOweAmount::where("user_id","=",$id)->first();
