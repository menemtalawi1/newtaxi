...
class AuthViaApple implements AuthInterface
{
	/**
	...
	public function create(Request $request)
	{
		...
		$user->password         = $request->has('password') ?? $request->password;
		...
		$profile->src          = $request->user_image ?? '';
		$profile->photo_source = 'Facebook';
		$profile->save();
