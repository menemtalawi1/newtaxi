...
class StripePayout
{
    ...
    protected function getVerificationData($request)
    {
        ...
        $capability_countries = ['US','AU','AT','BE','CZ','DK','EE','FI','FR','DE','GR','IE','IT','LV','LT','LU','NL','NZ','NO','PL','PT','SK','SI','ES','SE','CH','GB','CA','SG','BR','HK'];
        $url = url('/');
        if(strpos($url, "localhost") > 0) {
        	$url = 'https://cabme.cloneappsolutions.com/';
        }
