...
Route::group(['prefix' => (LOGIN_USER_TYPE=='company')?'company':'admin', 'middleware' =>'admin_guest'], function () {
	...
	/* Manage Manage Mobile App Version Route Start*/

		Route::group(['middleware' => 'admin_can:manage_mobile_app_version'], function() {
			Route::get('mobile_app_version', 'AppVersionController@index');
		    Route::match(array('GET', 'POST'),'add_app_version', 'AppVersionController@add')->name('admin.add_app_version');
		    Route::match(array('GET', 'POST'),'edit_app_version/{id}', 'AppVersionController@update')->name('admin.edit_location');
		    Route::get('delete_app_version/{id}', 'AppVersionController@delete');
		});
		
	/* Manage Manage Mobile App Version Route End*/
